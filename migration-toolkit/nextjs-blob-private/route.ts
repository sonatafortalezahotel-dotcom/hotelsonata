/**
 * Colocar em: app/api/blob-proxy/[[...segments]]/route.ts
 * (não deixar este ficheiro na raiz; renomear/mover no App Router)
 */
 ...
 * O browser chama /api/blob-proxy/... em vez de aceder a *.private.blob… (403 em directo).
 */
