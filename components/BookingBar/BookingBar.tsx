...
import { Calendar as CalendarIcon, Users, Search, Loader2, ChevronDown, Tag } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="p-1.5 lg:p-2">
            <div className="flex flex-col lg:flex-row items-stretch gap-0 lg:gap-0">
              {/* Campo de Check-in */}
              <div className="flex-1 border-r-0 lg:border-r border-white/10 dark:border-white/10 pr-0 lg:pr-6 lg:pl-2 mb-3 lg:mb-0">
                {isMounted ? (
                  <Popover>
              ...
              {/* Campo de Check-out */}
              <div className="flex-1 border-r-0 lg:border-r border-white/10 dark:border-white/10 pr-0 lg:pr-6 lg:pl-6 mb-3 lg:mb-0">
                {isMounted ? (
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
